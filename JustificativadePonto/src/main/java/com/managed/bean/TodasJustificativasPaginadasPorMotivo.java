...
@RequestScoped
@ManagedBean(name = "todasJustificativasPaginadasPorMotivo")
public class TodasJustificativasPaginadasPorMotivo implements Serializable {
        ...
        if(justificativas == null){
            justificativas = new LazyDataModel<JustificativaPonto>() {
                ...
                public List<JustificativaPonto> load(int i, int i1, String s, SortOrder sortOrder, Map<String, String> stringStringMap) {
                    List<JustificativaPonto> resultado = service.todasPorMotivo(i, i1);
